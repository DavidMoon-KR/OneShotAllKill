...
public class Player : MonoBehaviour
{
    ...
    void FirstShotOptimization()
    {
        GameObject FirstShot = Instantiate(m_BulletPrefab[(int)m_SelectBulletType], m_BulletTransform.transform.position, m_BulletTransform.rotation);
        Destroy(FirstShot);
